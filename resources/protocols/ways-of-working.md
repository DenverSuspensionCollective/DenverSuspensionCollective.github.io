---
layout: standalone
title: Ways of Working During a Suspension
---
...
{% include heading_block.html title="The Suspendee Comes First" %}
...
{% include heading_block.html title="Roles Are Assigned but Fluid" %}
...
{% include heading_block.html title="One Voice to the Suspendee" %}
...
{% include heading_block.html title="Communicate Concerns Discreetly" %}
...
{% include heading_block.html title="Mind Your Language Around the Suspendee" %}
...
{% include heading_block.html title="Resolve Disagreements Away From the Suspendee" %}
...
{% include heading_block.html title="Observers Are Part of the Space" %}
